...
* This project is a fork of [Original Author's Repository](https://github.com/skymakerolof/dxf).  Thank you to the original author for their great work!

* Modified based on the original author's work to better align with my business goals.
  * Added support for customizing and exporting SVG styles through configuration, such as scaling ratio, stroke styles, etc.
  * Fixed issues caused by `scaleX`/`scaleY` during conversion: instead of scaling entities directly, now transforms scaling into coordinate adjustments.
  * Filtered out invalid data during the conversion process.
